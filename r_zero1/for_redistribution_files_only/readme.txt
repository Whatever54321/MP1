r_zero1 MATLAB .NET Assembly (.NET Component)
...
r_zero1_overview.html - HTML overview documentation file for the generated component. It 
                        contains the requirements for accessing the component and for 
                        generating arguments using the MWArray class hierarchy.

r_zero1.xml - This file contains the code comments for the r_zero1 component classes and 
                        ...
                        online documentation for the r_zero1 component.
