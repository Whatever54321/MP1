...
namespace fmincon_r
{
  ...
  public class f_method1 : IDisposable
  {
    ...
    ///
    public MWArray fmincon_r()
    {
      return mcr.EvaluateFunction("fmincon_r", new MWArray[]{});
    }
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray fmincon_r(MWArray str1)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray fmincon_r(MWArray str1, MWArray str2)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray fmincon_r(MWArray str1, MWArray str2, MWArray x0)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray fmincon_r(MWArray str1, MWArray str2, MWArray x0, MWArray lbvalue)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] fmincon_r(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "fmincon_r", new MWArray[]{});
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] fmincon_r(int numArgsOut, MWArray str1)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] fmincon_r(int numArgsOut, MWArray str1, MWArray str2)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] fmincon_r(int numArgsOut, MWArray str1, MWArray str2, MWArray x0)
    {
    ...
    ///
    public MWArray[] fmincon_r(int numArgsOut, MWArray str1, MWArray str2, MWArray x0, 
                         MWArray lbvalue, MWArray ubvalue)
    {
    ...
    ///
    public void fmincon_r(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("fmincon_r", numArgsOut, ref argsOut, argsIn);
    }
