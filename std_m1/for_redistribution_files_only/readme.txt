std_m1 MATLAB .NET Assembly (.NET Component)
...
std_m1_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

std_m1.xml - This file contains the code comments for the std_m1 component classes and 
                       ...
                       online documentation for the std_m1 component.
